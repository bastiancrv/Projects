    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <section class="container-fluid">
                ...
                <button class="navbar-toggler fixed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item ms-auto">
                            <a class="nav-link active text-light" href="offre.php">Offres d'emplois</a>
                        </li>
                        <li class="nav-item ms-auto">
        ...
        <section id="navbarsearch" class="container-fluid">
            <h1> Bienvenue sur le site numéro 1 de recherche d'emploi</h1>
    ...
    <section id="job-listings" class="container job-listings-section">
        ...
        <div class="row justify-content-center">
            ...
            <div class="button-container">
                <a href="offre.php" class="btn btn-primary">Voir d'autres offres</a>
            </div>
        </div>
    </section>
    ...
    <section class="appli">
        <div class="row justify-content-center">
            <div class="col-md-12 text-center">
                <img src="images/banniere.png" alt="pub" class="img-fluid">
            </div>
        </div>
    </section>
